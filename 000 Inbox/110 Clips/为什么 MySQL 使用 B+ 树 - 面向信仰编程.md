---
title: "为什么 MySQL 使用 B+ 树 - 面向信仰编程"
source: "https://draven.co/whys-the-design-mysql-b-plus-tree/"
author:
published:
created: 2025-04-05
description:
...
![mysql-and-storage-engine](https://img.draven.co/mysql-and-storage-engine.png)
...
> 想要详细了解 MySQL 默认存储引擎的读者，可以通过之前的文章 [『浅入浅出』MySQL 和 InnoDB](https://draven.co/mysql-innodb.html) 了解包括 InnoDB 存储方式、索引和锁等内容，我们在这里主要不会介绍 InnoDB 相关的过多内容。
...
![potential-data-structures](https://img.draven.co/potential-data-structures.png)
...
![olap-and-oltp](https://img.draven.co/olap-and-oltp.png)
...
![log-as-database](https://img.draven.co/log-as-database.png)
...
![disk-io-cost](https://img.draven.co/disk-io-cost.png)
...
![b-tree](https://img.draven.co/b-tree.png)
...
![mysql-innodb-b-plus-tree](https://img.draven.co/mysql-innodb-b-plus-tree.png)
...
你可以在 [技术文章配图指南](https://draven.co/sketch-and-sketch) 中找到画图的方法和素材。
